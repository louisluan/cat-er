...
xtreg O_RCV_stock LTI_ro  ln_TA TA_to DEBT_ro RCV_to i.dindc i.FY  if soetag==1,fe 
est store FE_SOE_STOCK
xtreg O_RCV_stock LTI_ro  ln_TA TA_to DEBT_ro RCV_to i.dindc i.FY  if soetag==1,re 
...
xtreg O_RCV_flow LTI_ro  ln_TA TA_to DEBT_ro RCV_to  i.dindc i.FY if  soetag==1,fe 
est store FE_SOE_FLOW
xtreg O_RCV_flow LTI_ro  ln_TA TA_to DEBT_ro RCV_to i.dindc i.FY if  soetag==1,re 
...
xtreg O_RCV_stock LTI_ro  ln_TA TA_to DEBT_ro RCV_to i.dindc i.FY  if soetag==0,fe 
est store FE_NONSOE_STOCK
xtreg O_RCV_stock LTI_ro  ln_TA TA_to DEBT_ro RCV_to i.dindc i.FY  if soetag==0,re 
...
xtreg O_RCV_flow LTI_ro  ln_TA TA_to DEBT_ro RCV_to i.FY i.dindc if  soetag==0,fe 
est store FE_NONSOE_FLOW
xtreg O_RCV_flow LTI_ro  ln_TA TA_to DEBT_ro RCV_to i.FY i.dindc if  soetag==0,re 
